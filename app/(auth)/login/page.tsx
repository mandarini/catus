    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-background to-amber-50/30 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="mt-6 text-2xl font-bold text-foreground">Welcome to Catus</h1>
          <p className="mt-2 text-sm text-muted-foreground">Sign in to track your cat's health and life</p>
        </div>
        ...
        <div className="rounded-2xl border bg-card shadow-lg shadow-black/5 p-8">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 rounded-xl border bg-background px-4 py-3.5 text-sm font-semibold text-foreground hover:bg-muted transition-colors disabled:opacity-60"
          >
